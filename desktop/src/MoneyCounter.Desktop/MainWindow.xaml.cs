...
public partial class MainWindow : Window
{
    ...
    private readonly Func<Window> _imports, _simulation, _analytics;
    public MainWindow(RegistryViewModel vm, ILogger<RegistryEditor> editorLogger, string windowPlacementPath, Func<MoneyCounter.Core.Registry.DeviceDetail, OperationsViewModel> operations, Func<MoneyCounter.Core.Registry.DeviceDetail, MoneyCounter.Core.Operations.AnomalyDetail?, MaintenanceWindow> maintenance, Func<MoneyCounter.Core.Registry.DeviceDetail?, MoneyCounter.Core.Maintenance.FaultDetail?, Window> inventory, Func<Window> imports, Func<Window> simulation, Func<Window> analytics)
    {
        InitializeComponent(); _vm = vm; _editorLogger = editorLogger; _operations = operations; _maintenance = maintenance; _inventory = inventory; _imports = imports; _simulation = simulation; _analytics = analytics; _placement = new WindowPlacement(windowPlacementPath); DataContext = vm;
